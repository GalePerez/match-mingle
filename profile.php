    ...
    <div class="profile-container">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="hobbies" name="hobbies[]" multiple="multiple">
                            <option value="sleeping"
                                <?php echo (isset($userData['hobbies']['sleeping']) ? 'selected' : ''); ?>>
                                Sleeping</option>
                            <option value="eating"
                                <?php echo (isset($userData['hobbies']['eating']) ? 'selected' : ''); ?>>Eating
                            </option>
                            <option value="reading"
                                <?php echo (isset($userData['hobbies']['reading']) ? 'selected' : ''); ?>>Reading
                            </option>
                            <option value="cooking"
                                <?php echo (isset($userData['hobbies']['cooking']) ? 'selected' : ''); ?>>Cooking
                            </option>
                            <option value="writing"
                                <?php echo (isset($userData['hobbies']['writing']) ? 'selected' : ''); ?>>Writing
                            </option>
                            <option value="dancing"
                                <?php echo (isset($userData['hobbies']['dancing']) ? 'selected' : ''); ?>>Dancing
                            </option>
                        </select>
                    </div>
                    <div class="mb-3">
        ...
        <div class="container-4">
            <div class="mb-3">
                ...
                <input class="form-control" type="file" id="galleryImages"
                    onchange="previewProfileImage('galleryImages')" multiple accept="image/png">
            </div>
            <div class="photos" style="display:flex;">
                <div class="card m-2" style="width: 150px; height: 150px">
                    <?php if ($userData['gallery_pic_1'] != "") { ?>
                    <img src="<?php echo BASE_URL ?>uploads/<?php echo $userData['gallery_pic_1'] ?>"
                ...
                <div class="card m-2" style="width: 150px; height: 150px">
                    ...
                    <img src="<?php echo BASE_URL ?>uploads/<?php echo $userData['gallery_pic_2'] ?>"
